...
import { useFilteredResponses, getMeta, useFilters } from "../lib/filters";
...
export function Overview() {
  ...
  const setPlataformas = useFilters((s) => s.setPlataformas);
  const setBarreras = useFilters((s) => s.setBarreras);
        ...
        <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
            <Card className="lg:col-span-2">
              <CardTitle subtitle="Clic en un segmento para filtrar">Distribución por dirección</CardTitle>
              <DonutChart
                data={dirData}
            ...
            <Card className="lg:col-span-3">
              <CardTitle subtitle="Clic en una barra para filtrar colaboradores por esa plataforma">Top herramientas</CardTitle>
              <HorizontalBar
                data={topTools}
                labelWidth={140}
                height={320}
                onItemClick={(label) => {
                  setPlataformas([label]);
                  navigate("/individuales");
                }}
              />
            </Card>
            ...
            <Card className="lg:col-span-5">
              <CardTitle subtitle="Clic en una barra para filtrar por esa barrera · pasa el cursor para ver la descripción completa">
                Top barreras
              </CardTitle>
              <HorizontalBar
                data={topBarriers}
                labelWidth={220}
                onItemClick={(label) => {
                  // Las barreras vienen como "Carga Operativa: El ritmo..." → guardamos solo la parte antes del ":"
